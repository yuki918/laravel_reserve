...
Route::middleware('can:user-higher')->group(function() {
  ...
  // Route::get('detail/{id}', [ReservationController::class, 'detail'])->name('events.detail');
  Route::post('detail/{id}', [ReservationController::class, 'reserve'])->name('events.reserve');
});
Route::middleware('auth')->get('detail/{id}', [ReservationController::class, 'detail'])->name('events.detail');
